...
- We implemented Svizky-Gulay which is one of the digital filtering methods (convolution process). In this method, the local 
  ...
  Here we implemented the data filtering for diffrent values of *n<sub>f</sub>* (degree of polynomal) and *n<sub>w</sub>* (grid point) and same time frame of simulation  <img src="https://latex.codecogs.com/gif.latex?\omega_{ci}t=50.
